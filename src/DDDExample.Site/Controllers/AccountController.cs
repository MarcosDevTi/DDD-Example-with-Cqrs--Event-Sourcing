...
using DDDExample.Identity.Extensions;
using DDDExample.Identity.Models;
using DDDExample.Identity.Models.AccountViewModels;
using DDDExample.Identity.Services;
using DDDExample.SharedKernel.Cqrs;
using DDDExample.Site.Extentions;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _processor.Send(
                    new CreateCustomer(model.Email, model.Email, model.Email, DateTime.Now.AddYears(-20), "", "", "", "", new Guid(user.Id)));
